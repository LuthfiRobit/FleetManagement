...
@section('title','Laporan Penugasan Driver | History')
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-title">
                        <h2 class="fw-bolder">HISTORY PENUGASAN DRIVER</h2>
                    </div>
                    <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            <form action="">
                                ...
                                <div class="form-group d-flex mb-8 row flex-row-reverse">
                                    <div class="col-lg-2">
                                        <button type="button" id="kt_modal_new_target_cancel" class="btn btn-light" onclick="location.href='{{route('assign.history.driver')}}';">Reset</button>
                                    </div>
                                    <div class="col-lg-2">
                                ...
                                <table id="kt_datatable_example_5"
                                    ...
                                    <thead>
                                        <tr class="fw-bolder fs-6 text-gray-800 px-7">
                                            ...
                                            <th>Penugasan Baru</th>
                                            <th>Penugasan Diterima</th>
                                            <th>Penugasan Perjalanan</th>
                                            <th>Penugasan Selesai</th>
                                            <th>Penugasan Batal</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
<script text="text/javascript">
    ...
    $(function () {
        ...
        $(".obutn").click(function() {
            // alert('ok');
            $(this).closest("form").attr("action", "{{route('assign.exprt.history.pdf')}}");     
        });
        ...
        var options = {
            series: [{
                ...
                data: [@foreach ($history as $h){{$h['history']['jumlah_all']}},@endforeach]
            }],
            chart: {
                fontFamily: 'inherit',
                type: 'area',
