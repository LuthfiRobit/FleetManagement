            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted mt-1 fw-bold fs-7">{{ $jenis_alokasi->nama_alokasi}}</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body py-3">
                    ...
                    <form id="kt_modal_new_target_form" class="form"
                        action="{{ route('dashboard.kendaraan.jenis_alokasi.update',$jenis_alokasi->id_jenis_alokasi)}}"
                        ...
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Edit Jenis Alokasi</h1>
                            <!--end::Title-->
                            <!--begin::Description-->
                            <!--end::Description-->
                        </div>
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Target Title"
                                name="nama_alokasi" value="{{ $jenis_alokasi->nama_alokasi}}" />
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            {{-- <div class="col-md-6 fv-row"> --}}
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                    ...
                                    <option value="y" {{$jenis_alokasi->status == 'y' ? 'selected' : ''}}>
                                        Aktif</option>
                                    <option value="t" {{$jenis_alokasi->status == 't' ? 'selected' : ''}}>
                                        Non Aktif</option>
                                </select>
                                {{--
                            </div> --}}
        ...
        init: function () {
            (
                ...
                $(a.querySelector('[name="nama_alokasi"]')).on("change", (function () {
                    n.revalidateField("nama_alokasi")
                        ...
                        nama_alokasi: {
                            validators: {
                                ...
                                stringLength: {
                                    // options: {
                                    max: 50,
                                    message: "Nama Jenis Alokasi Maksimal 50 Karakter"
                                    // }
                                }
                            }
                        },
