            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Edit Jenis Pengecekan</span>
                        <span class="text-muted mt-1 fw-bold fs-7">{{ $jenisPengecekan->jenis_pengecekan}}</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body py-3">
                    ...
                    <form id="kt_modal_new_target_form" class="form"
                        action="{{ route('dashboard.pengecekan.jenis.update',$jenisPengecekan->id_jenis_pengecekan)}}"
                        ...
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Edit Jenis Pengecekan</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Input group-->
                        <input type="hidden" name="id_kriteria" value="{{ $jenisPengecekan->id_kriteria}}" />
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">Nama Jenis Pengecekan</span>
                            ...
                            <input type="text" class="form-control form-control-solid"
                                ...
                                value="{{ $jenisPengecekan->jenis_pengecekan}}" />
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            {{-- <div class="col-md-6 fv-row"> --}}
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                    ...
                                    <option value="y" {{$jenisPengecekan->status == 'y' ? 'selected' : ''}}>
                                        Aktif</option>
                                    <option value="t" {{$jenisPengecekan->status == 't' ? 'selected' : ''}}>
                                        Non Aktif</option>
                                </select>
                                {{--
                            </div> --}}
            ...
            (
                        ...
                        jenis_pengecekan: {
                            validators: {
                                ...
                                stringLength: {
                                    // options: {
                                    max: 60,
                                    message: "Jenis Pengecekan Maksimal 60 Karakter"
                                    // }
                                }
                            }
                        },
                ...
                e.addEventListener("click", (function (t) {
                    t.preventDefault(), Swal.fire({
                        ...
                        t.value ?
                        (a.reset(), window.location.href = "{{ route('dashboard.pengecekan.jenis.index','id='.$jenisPengecekan->id_kriteria) }}") : "cancel" === t.dismiss && Swal.fire({
