            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Data Departemen</span>
                        <span class="text-muted mt-1 fw-bold fs-7">{{$departemen->count()}} Departemen</span>
                    </h3>
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        title="" data-bs-original-title="Tekan untuk menambah departemen">
                        <a href="#" class="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal"
                            ...
                            <!--end::Svg Icon-->Tambah Departemen
                        </a>
                    </div>
                </div>
                <!--end::Header-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <a href="{{ route('dashboard.petugas.departemen.edit',$d->id_departemen)}}"
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_feul_form" class="form"
                        action="{{route('dashboard.petugas.departemen.store')}}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Input Departemen</h1>
                            <!--end::Title-->
                            <!--begin::Description-->
