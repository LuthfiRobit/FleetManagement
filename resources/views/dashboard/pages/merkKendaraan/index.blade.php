                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        ...
                        <a href="#" class="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal"
                            ...
                            <!--end::Svg Icon-->Tambah Merk Kendaraan
                        </a>
                    </div>
                </div>
                <!--end::Header-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <a href="{{ route('dashboard.kendaraan.merk.edit',$mKendaraan->id_merk)}}"
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form"
                        action="{{route('dashboard.kendaraan.merk.store')}}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Input Merk Kendaraan</h1>
                            <!--end::Title-->
                            <!--begin::Description-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Masukkan Nama Merk"
                                name="nama_merk" />
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
