            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Edit Bahan Bakar</span>
                        <span class="text-muted mt-1 fw-bold fs-7">{{ $bahanBakar->nama_bahan_bakar}}</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body py-3">
                    ...
                    <form id="kt_modal_new_target_form" class="form"
                        action="{{ route('dashboard.bahanbakar.update',$bahanBakar->id_bahan_bakar)}}" method="POST"
                        ...
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Edit Bahan Bakar</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                ...
                                value="{{ $bahanBakar->nama_bahan_bakar}}" />
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            {{-- <div class="col-md-6 fv-row"> --}}
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                    ...
                                    <option value="y" {{$bahanBakar->status == 'y' ? 'selected' : ''}}>
                                        Aktif</option>
                                    <option value="t" {{$bahanBakar->status == 't' ? 'selected' : ''}}>
                                        Non Aktif</option>
                                </select>
                                {{--
                            </div> --}}
