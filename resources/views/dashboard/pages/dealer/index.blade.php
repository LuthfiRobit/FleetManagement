                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <a href="{{ route('dashboard.dealer.edit',$de->id_dealer)}}"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_feul_form" class="form" action="{{route('dashboard.dealer.store')}}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Input Dealer</h1>
                            <!--end::Title-->
                            <!--begin::Description-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <textarea name="alamat" class="form-control form-control-solid"
                                placeholder="Masukkan Alamat Dealer"></textarea>
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            ...
                            <input type="number" class="form-control form-control-solid"
                                placeholder="Masukkan No. Tlfn Dealer" name="no_tlp" />
                        </div>
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
