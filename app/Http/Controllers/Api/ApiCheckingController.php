...
class ApiCheckingController extends Controller
{
    public function listKendaraan(Request $request)
    {
        ...
        $kendaraanCount = DB::table('tb_kendaraan')
            ->select(DB::raw("
        ...
        return response()->json(
            [
                ...
                'jumlah_data'       => $kendaraanCount->count(),
                'list_kendaraan'    => $kendaraanLimit
            ]
        );
        // $kendaraan =  DB::select(
        //     'SELECT
        ...
        //     AND tb_pengecekan_kendaraan.status_kendaraan = 't'
        //     AND  tb_pengecekan_kendaraan.jam_pengecekan BETWEEN '$jam_awal' AND '$jam_akhir'
        //     AND tb_pengecekan_kendaraan.tgl_pengecekan = '$tgl_sekarang'
        //     UNION SELECT id_kendaraan FROM tb_penugasan_driver WHERE tb_penugasan_driver.id_kendaraan = tb_kendaraan.id_kendaraan
        //     AND tb_penugasan_driver.tgl_penugasan = '$tgl_sekarang')"
        // );
    }
